...
set out "dist1.pdf"
plot "data_FSHD2.csv" using 1:($4/0.9755227051) title "FSHD" with lines, \
 "data_ESF2.csv" using 1:($4/0.8717419088) title "ESF" with lines, \
 "data_FPFH2.csv" using 1:($4/0.9351668998) title "FPFH" with lines, \
 "data_SHOT2.csv" using 1:($4/0.9903120331) title "SHOT" with lines
