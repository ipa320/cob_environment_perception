...
int main(int argc, char **argv) {
	...
	ns::TContext ctxt_;	
	ns::TGraph graph_;
	ns::TMapCells cells_(graph_);
	ns::TMapTransformations trans_(graph_);
	
	cob_3d_experience_mapping::ContextContainer<ns::TContext, ns::TGraph, ns::TMapCells, ns::TMapTransformations> container(ctxt_, graph_, cells_, trans_);
