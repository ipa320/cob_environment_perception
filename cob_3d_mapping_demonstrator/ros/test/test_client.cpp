...
int main(int argc, char **argv)
{
   ...
   */
 // ros::Publisher chatter_pub = n.advertise<brics_actuator::JointPositions>("/mapping_demonstrator_node/command_pos", 1);
  ...
  while (ros::ok())
  {
    ...
    brics_actuator::JointValue jointVal1;
    jointVal1.timeStamp = ros::Time::now();
    jointVal1.joint_uri = "stepper";
    jointVal1.unit = "rad";
    jointVal1.value = 0.7;
