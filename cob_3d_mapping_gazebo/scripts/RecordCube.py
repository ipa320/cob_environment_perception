...
#		res_set = srv_set_model_state(req_set)
		req_set.model_state.pose.position.x = -1.77
		req_set.model_state.pose.position.y = 1.77
		req_set.model_state.pose.position.z = 0
		req_set.model_state.pose.orientation.w = 0.923879533
		req_set.model_state.pose.orientation.x = 0
		req_set.model_state.pose.orientation.y = 0
		req_set.model_state.pose.orientation.z = -0.382683432
		res_set = srv_set_model_state(req_set)
