/* Auto-generated by genmsg_cpp for file /home/goa-jh/workspace/registration/srv/Parameterlist.srv */
#ifndef REGISTRATION_SERVICE_PARAMETERLIST_H
#define REGISTRATION_SERVICE_PARAMETERLIST_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "registration/ParameterlistRequest"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::registration::ParameterlistRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::registration::ParameterlistRequest_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct ParameterlistRequest
typedef  ::registration::ParameterlistRequest_<std::allocator<void> > ParameterlistRequest;

typedef boost::shared_ptr< ::registration::ParameterlistRequest> ParameterlistRequestPtr;
typedef boost::shared_ptr< ::registration::ParameterlistRequest const> ParameterlistRequestConstPtr;
...
private:
  static const char* __s_getDataType_() { return "registration/ParameterlistResponse"; }
public:
  ROS_DEPRECATED static const std::string __s_getDataType() { return __s_getDataType_(); }
...
public:
  ...
  typedef boost::shared_ptr< ::registration::ParameterlistResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::registration::ParameterlistResponse_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct ParameterlistResponse
typedef  ::registration::ParameterlistResponse_<std::allocator<void> > ParameterlistResponse;

typedef boost::shared_ptr< ::registration::ParameterlistResponse> ParameterlistResponsePtr;
typedef boost::shared_ptr< ::registration::ParameterlistResponse const> ParameterlistResponseConstPtr;
...
{
template<class ContainerAllocator> struct IsMessage< ::registration::ParameterlistRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::registration::ParameterlistRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::registration::ParameterlistRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "b4aad5f78eda10079d708a8d4b303dba";
  }

  static const char* value(const  ::registration::ParameterlistRequest_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xb4aad5f78eda1007ULL;
  static const uint64_t static_value2 = 0x9d708a8d4b303dbaULL;
};

template<class ContainerAllocator>
struct DataType< ::registration::ParameterlistRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "registration/ParameterlistRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::registration::ParameterlistRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "string[] names\n\
string[] values\n\
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::registration::ParameterlistResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::registration::ParameterlistResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::registration::ParameterlistResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "0f26af2399fbfbc8170d9a60ed7b9846";
  }

  static const char* value(const  ::registration::ParameterlistResponse_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x0f26af2399fbfbc8ULL;
  static const uint64_t static_value2 = 0x170d9a60ed7b9846ULL;
};

template<class ContainerAllocator>
struct DataType< ::registration::ParameterlistResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "registration/ParameterlistResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::registration::ParameterlistResponse_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct IsFixedSize< ::registration::ParameterlistResponse_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::registration::ParameterlistRequest_<ContainerAllocator> >
{
...
template<class ContainerAllocator> struct Serializer< ::registration::ParameterlistResponse_<ContainerAllocator> >
{
  template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
  {
...
{
template<>
struct MD5Sum<registration::Parameterlist> {
  static const char* value() 
  {
    return "b53ad76a356e707c7b3aa8a4b8e9a778";
  }

  static const char* value(const registration::Parameterlist&) { return value(); } 
};

template<>
struct DataType<registration::Parameterlist> {
  static const char* value() 
  {
    return "registration/Parameterlist";
  }
...
#endif // REGISTRATION_SERVICE_PARAMETERLIST_H
