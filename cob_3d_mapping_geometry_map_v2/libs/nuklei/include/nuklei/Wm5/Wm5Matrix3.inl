    ...
    Matrix3& diag, Matrix3& rightTranspose) const
{
    ...
    nuklei_wmf::SingularValueDecomposition<Real>(M, tmpL, tmpD, tmpRTranspose);
...
bool Matrix3<Real>::QLAlgorithm (Real diagonal[3], Real subdiagonal[2])
{
    ...
    // "Matrix3 Computations" by Gene H. Golub and Charles F. Van Loan,
