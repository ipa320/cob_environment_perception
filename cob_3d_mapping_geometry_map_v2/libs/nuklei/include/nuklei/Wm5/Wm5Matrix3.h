...
#ifndef NUKLEI_WMFMATRIX3_H
#define NUKLEI_WMFMATRIX3_H
...
public:
    ...
    // Special matrices.
    NUKLEI_WMF_MATHEMATICS_ITEM static const Matrix3 ZERO;
    NUKLEI_WMF_MATHEMATICS_ITEM static const Matrix3 IDENTITY;
