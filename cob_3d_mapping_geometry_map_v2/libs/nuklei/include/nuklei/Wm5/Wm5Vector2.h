...
#ifndef NUKLEI_WMFVECTOR2_H
#define NUKLEI_WMFVECTOR2_H
...
public:
    ...
    // Special vectors.
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector2 ZERO;    // (0,0)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector2 UNIT_X;  // (1,0)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector2 UNIT_Y;  // (0,1)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector2 ONE;     // (1,1)
