...
#ifndef NUKLEI_WMFQUATERNION_H
#define NUKLEI_WMFQUATERNION_H
...
public:
    ...
    // Special quaternions.
    NUKLEI_WMF_MATHEMATICS_ITEM static const Quaternion ZERO;
    NUKLEI_WMF_MATHEMATICS_ITEM static const Quaternion IDENTITY;
