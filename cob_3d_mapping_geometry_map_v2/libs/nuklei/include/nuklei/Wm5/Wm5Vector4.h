...
#ifndef NUKLEI_WMFVECTOR4_H
#define NUKLEI_WMFVECTOR4_H
...
public:
    ...
    // Special vectors.
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector4 ZERO;
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector4 UNIT_X;  // (1,0,0,0)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector4 UNIT_Y;  // (0,1,0,0)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector4 UNIT_Z;  // (0,0,1,0)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector4 UNIT_W;  // (0,0,0,1)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector4 ONE;     // (1,1,1,1)
