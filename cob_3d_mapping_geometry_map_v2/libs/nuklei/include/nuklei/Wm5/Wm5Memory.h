...
#ifndef NUKLEI_WMFMEMORY_H
#define NUKLEI_WMFMEMORY_H
...
class NUKLEI_WMF_CORE_ITEM Memory
{
public:
...
//----------------------------------------------------------------------------
inline void* operator new (size_t numBytes, const nuklei_wmf::Memory& memory)
{
    if (memory.HasMap())
    {
    ...
    {
#ifdef NUKLEI_WMF_USE_MEMORY_ASSERT_ON_PREINIT_POSTTERM_OPERATIONS
...
//----------------------------------------------------------------------------
inline void operator delete (void*, const nuklei_wmf::Memory&)
{
    // Only called during exception handling.
}
//----------------------------------------------------------------------------

#define new0 new(nuklei_wmf::Memory(__FILE__,__LINE__))
#define new1 nuklei_wmf::Memory(__FILE__,__LINE__).New1
#define new2 nuklei_wmf::Memory(__FILE__,__LINE__).New2
#define new3 nuklei_wmf::Memory(__FILE__,__LINE__).New3
#define new4 nuklei_wmf::Memory(__FILE__,__LINE__).New4
#define delete0 nuklei_wmf::Memory(__FILE__,__LINE__).Delete0
#define delete1 nuklei_wmf::Memory(__FILE__,__LINE__).Delete1
#define delete2 nuklei_wmf::Memory(__FILE__,__LINE__).Delete2
#define delete3 nuklei_wmf::Memory(__FILE__,__LINE__).Delete3
#define delete4 nuklei_wmf::Memory(__FILE__,__LINE__).Delete4
