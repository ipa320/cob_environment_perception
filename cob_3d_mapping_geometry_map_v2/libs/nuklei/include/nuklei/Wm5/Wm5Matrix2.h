...
#ifndef NUKLEI_WMFMATRIX2_H
#define NUKLEI_WMFMATRIX2_H
...
public:
    ...
    // Special matrices.
    NUKLEI_WMF_MATHEMATICS_ITEM static const Matrix2 ZERO;
    NUKLEI_WMF_MATHEMATICS_ITEM static const Matrix2 IDENTITY;
