...
#ifndef NUKLEI_WMFMATRIX4_H
#define NUKLEI_WMFMATRIX4_H
...
public:
    ...
    // Special matrices.
    NUKLEI_WMF_MATHEMATICS_ITEM static const Matrix4 ZERO;
    NUKLEI_WMF_MATHEMATICS_ITEM static const Matrix4 IDENTITY;
