...
#ifndef NUKLEI_WMFVECTOR3_H
#define NUKLEI_WMFVECTOR3_H
...
public:
    ...
    // Special vectors.
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector3 ZERO;    // (0,0,0)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector3 UNIT_X;  // (1,0,0)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector3 UNIT_Y;  // (0,1,0)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector3 UNIT_Z;  // (0,0,1)
    NUKLEI_WMF_MATHEMATICS_ITEM static const Vector3 ONE;     // (1,1,1)
