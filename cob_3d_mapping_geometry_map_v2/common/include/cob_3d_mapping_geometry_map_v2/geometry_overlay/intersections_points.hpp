...
#ifndef BOOST_GEOMETRY_GEOMETRY_POLICIES_RELATE_INTERSECTION_POINTS_HPP2
#define BOOST_GEOMETRY_GEOMETRY_POLICIES_RELATE_INTERSECTION_POINTS_HPP2
...
namespace traits {
template<class Point, typename coordinate_type> struct intersection_interpolation
{	
...
struct segments_intersection_points
{
                ...
                T const& dx, T const& dy)
    {
        ...
        boost::geometry::traits::intersection_interpolation<Point, coordinate_type>::interpolate(point, segment.first, segment.second, boost::numeric_cast
            <
                coordinate_type
            >(numerator * dy_promoted / denominator));
    }
